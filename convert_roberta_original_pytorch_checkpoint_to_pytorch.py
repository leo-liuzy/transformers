...
def convert_roberta_checkpoint_to_pytorch(
    ...
    # bp() # our fairseq checkpoint might contains padding
    model.roberta.embeddings.word_embeddings.weight.data[hf_roberta_mask_idx] = model.roberta.embeddings.word_embeddings.weight.data[roberta_mask_idx]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_file", default="model.pt", type=str, help="Path to the output PyTorch model."
    )
    args = parser.parse_args()
    convert_roberta_checkpoint_to_pytorch(
        args.roberta_checkpoint_path, args.pytorch_dump_folder_path, args.classification_head, args.checkpoint_file,
    )
